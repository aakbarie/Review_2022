...
subtitle: "Linear regression model using subsets selection methods"
...
Thus the calculation of the final model from backward selection on the hold out testset yields an error rate of **`r round(pred_test$error_rate, 2)`** with an average prediction interval for price between **`r pred_test$mean_lw_bound` and `r pred_test$mean_up_bound`** while the average predicted price is **`r pred_test$mean_diff`**
